...
/// <summary>
/// Endpoint responsável por enviar um e-mail contendo um contrato como anexo.
/// </summary>
/// <remarks>
/// Implementa a interface <see cref="IEndpoint"/> para mapear a rota de envio de e-mails com contratos.
/// </remarks>
public class SendContractEmailEndpoint : IEndpoint
{
    /// <summary>
    /// Mapeia o endpoint para enviar um e-mail com o contrato.
    /// </summary>
    /// <remarks>
    /// Registra a rota POST que recebe os dados do e-mail e do contrato e chama o manipulador para enviar o e-mail.
    /// </remarks>
    ...
    /// <summary>
    /// Manipulador da rota que recebe a requisição para enviar um e-mail com o contrato.
    /// </summary>
    /// <remarks>
    /// Este método busca o contrato no banco de dados, verifica sua existência, gera o caminho do anexo
    /// e chama o serviço de e-mail para enviar o contrato. Retorna uma resposta apropriada com base no resultado.
    /// </remarks>
    /// <param name="emailService">Instância de <see cref="IEmailService"/> responsável pelo envio de e-mails.</param>
    /// <param name="request">Objeto <see cref="AttachmentMessage"/> contendo os dados do e-mail e do contrato.</param>
    /// <param name="context">Instância de <see cref="AppDbContext"/> para acesso ao banco de dados.</param>
    /// <returns>
    /// Um objeto <see cref="IResult"/> representando a resposta HTTP:
    /// <para>- HTTP 200 OK, se o e-mail for enviado com sucesso;</para>
