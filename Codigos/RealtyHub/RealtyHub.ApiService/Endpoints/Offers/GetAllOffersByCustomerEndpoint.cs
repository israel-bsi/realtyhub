...
/// </summary>
/// <remarks>
/// Implementa a interface <see cref="IEndpoint"/> para mapear a rota de listagem de propostas feitas por um cliente.
/// </remarks>
public class GetAllOffersByCustomerEndpoint : IEndpoint
{
    ...
    /// </summary>
    /// <remarks>
    /// Registra a rota GET que retorna uma lista paginada de propostas feitas por um cliente específico.
    /// </remarks>
