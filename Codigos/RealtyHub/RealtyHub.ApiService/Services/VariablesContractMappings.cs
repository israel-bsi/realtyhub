...
public class VariablesContractMappings(Contract contract)
{
    public Dictionary<string, string> GetFields()
    {
        var paymentsFields = GetPaymentsText(contract.Offer!.Payments);
    ...
    private readonly Dictionary<string, string> _defaultFields = new()
    {
    ...
    private readonly Dictionary<string, string> _fieldsPj = new()
    {
    ...
    private readonly Dictionary<string, string> _fieldsPf = new()
    {
