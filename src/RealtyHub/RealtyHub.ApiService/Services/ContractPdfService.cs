...
public class ContractPdfService(Contract contract)
{
    private Dictionary<string, string> _defaultFields = new()
    {
        ...
        { "valorOferecido_proposta", contract.Offer!.Amount.ToString("C") },
        { "formaPagamento1", "" },
        { "formaPagamento2", "" },
        { "formaPagamento3", "" },
        { "formaPagamento4", "" },
    ...
    private Dictionary<string, string> _fieldsPj = new()
    {
    ...
    private Dictionary<string, string> _fieldsPf = new()
    {
